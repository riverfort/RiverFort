...
extension PriceChartCardController {
    private func createObservesr() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(onDidUpdatePriceChartDisplayMode), name: .didUpdatePriceChartDisplayMode, object: nil)
    }
    ...
    @objc private func onDidReceiveHistoricalPrice(notification: Notification) {
        ...
        priceChartPart.setChartDataForPrice(with: historicalPrice)
    }
    
    @objc private func onDidUpdatePriceChartDisplayMode() {
        print("onDidUpdatePriceChartDisplayMode")
    }
}
