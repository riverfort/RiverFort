...
// Source: YahooFinanceRealTimeQuote
//
...
struct YahooFinanceRealTimeQuote {
  ...
  var quoteType: YahooFinanceRealTimeQuote.QuoteType {
    get {return _storage._quoteType}
    set {_uniqueStorage()._quoteType = newValue}
  }

  var marketHours: YahooFinanceRealTimeQuote.MarketHoursType {
  ...
  var optionsType: YahooFinanceRealTimeQuote.OptionType {
...
extension YahooFinanceRealTimeQuote.QuoteType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [YahooFinanceRealTimeQuote.QuoteType] = [
    .none,
    .altsymbol,
    .heartbeat,
    .equity,
...
extension YahooFinanceRealTimeQuote.OptionType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [YahooFinanceRealTimeQuote.OptionType] = [
    .call,
    .put,
  ]
}

extension YahooFinanceRealTimeQuote.MarketHoursType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [YahooFinanceRealTimeQuote.MarketHoursType] = [
    .preMarket,
    .regularMarket,
    .postMarket,
    .extendedHoursMarket,
...
extension YahooFinanceRealTimeQuote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "YahooFinanceRealTimeQuote"
  ...
  fileprivate class _StorageClass {
    ...
    var _quoteType: YahooFinanceRealTimeQuote.QuoteType = .none
    var _marketHours: YahooFinanceRealTimeQuote.MarketHoursType = .preMarket
    ...
    var _optionsType: YahooFinanceRealTimeQuote.OptionType = .call
  ...
  static func ==(lhs: YahooFinanceRealTimeQuote, rhs: YahooFinanceRealTimeQuote) -> Bool {
...
extension YahooFinanceRealTimeQuote.QuoteType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "NONE"),
...
extension YahooFinanceRealTimeQuote.OptionType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CALL"),
    1: .same(proto: "PUT"),
  ]
...
extension YahooFinanceRealTimeQuote.MarketHoursType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
